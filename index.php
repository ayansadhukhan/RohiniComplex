...
<?php include("side.php") ; ?>
  ...
  <article class="content">
    <section>
      <table border="15" bordercolor="#5E2526" width="500" height="300" bgcolor="#148B7E" cellpadding="10" >
        <tbody>
          <tr>
...
<b> 
      ...
      <table align="center">
        <tr>
          ...
          <label for="username">UserName:</label></td><td>
            <input name="username" type="text" id="username" style="width:80%"></td>
        </tr>
        <tr>
          <td>
          <label for="password">Password:</label></td><td>
            <input name="password" type="text" id="pwd"  style="width:80%"></td>
        </tr>
    ...
    <p align="center">
    <div id="ButtonsetLogin" align="center">
